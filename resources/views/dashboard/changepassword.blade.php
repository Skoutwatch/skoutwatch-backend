                    ...
                    <form class="row" method="post" action="/password">
                        ...
                        <div class="col-xl-8 col-lg-9 col-md-12 col-sm-12">
                            <div class="form-group">
                                ...
                                <input type="password" class="form-control rounded" name="current_password" placeholder="">
                            </div>
                        </div>
                        <div class="col-xl-8 col-lg-9 col-md-12 col-sm-12">
                            <div class="form-group">
                                <label class="text-dark ft-medium">New Password</label>
                                <input type="password" class="form-control rounded" name="password" placeholder="">
                            </div>
                        </div>
