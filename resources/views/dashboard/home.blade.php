        ...
        <div class="colxl-12 col-lg-12 col-md-12">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="#" class="theme-cl">Payment Summary</a></li>
                    @else
    ...
    @if (auth()->user()->role == "Admin")
        <div class="row">
            <a href="#">
                <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                    <div class="dash-widgets py-5 px-4 bg-info rounded">
                        <h2 class="ft-medium mb-1 fs-xl text-light">{{ $transactions->count() }}</h2>
            ...
            <a href="#">
                <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                    <div class="dash-widgets py-5 px-4 bg-dark rounded">
                        <h2 class="ft-medium mb-1 fs-xl text-light">N {{ $transactions->sum('total')}}</h2>
                        <p class="p-0 m-0 text-light fs-md">Transaction Amount</p>
            ...
            <a href="#">
                <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                    <div class="dash-widgets py-5 px-4 bg-warning rounded">
                        <h2 class="ft-medium mb-1 fs-xl text-light">N {{ $transactions->where('status', 'Pending')->sum('total')}}</h2>
                        <p class="p-0 m-0 text-light fs-md">Pending Transactions</p>
            ...
            <a href="#">
                <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                    <div class="dash-widgets py-5 px-4 bg-purple rounded">
                        <h2 class="ft-medium mb-1 fs-xl text-light">N {{ $transactions->where('status', 'Pending')->sum('total')}}</h2>
                        <p class="p-0 m-0 text-light fs-md">Paid Transactions</p>
            ...
            <a href="#">
                <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                    <div class="dash-widgets py-5 px-4 bg-dark rounded">
                        <h2 class="ft-medium mb-1 fs-xl text-light"> {{ $users->count()}}</h2>
    ...
    @if (auth()->user()->role == "User")
        <div class="row">
            <a href="#">
                <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                    <div class="dash-widgets py-5 px-4 bg-info rounded">
                        ...
                        <p class="p-0 m-0 text-light fs-md">My Transactions</p>
                        <i class="lni lni-empty-file"></i>
                    </div>
                </div>
            </a>
            ...
            <a href="#">
                <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                    <div class="dash-widgets py-5 px-4 bg-warning rounded">
                        <h2 class="ft-medium mb-1 fs-xl text-light">N {{$user->transactions->where('status', 'Pending')->sum('total')}}</h2>
            ...
            <a href="#">
                <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                    <div class="dash-widgets py-5 px-4 bg-purple rounded">
                        <h2 class="ft-medium mb-1 fs-xl text-light">N {{$user->transactions->where('status', 'Paid')->sum('total')}}</h2>
                        <p class="p-0 m-0 text-light fs-md">Paid</p>
                        <i class="lni lni-heart"></i>
                    </div>
                </div>
            </a>
            <a href="#">
                <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                    <div class="dash-widgets py-5 px-4 bg-dark rounded">
                        <h2 class="ft-medium mb-1 fs-xl text-light"> {{ $user->coworkers->count()}}</h2>
                        <p class="p-0 m-0 text-light fs-md">Users </p>
                        <i class="lni lni-users"></i>
                    </div>
                </div>
