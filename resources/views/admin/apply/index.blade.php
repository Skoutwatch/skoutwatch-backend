        ...
        <div class="col-xl-12 col-lg-12 col-md-12">
            <div class="_dashboard_content bg-white rounded mb-4">
                ...
                <div class="_dashboard_content_body py-3 px-3">
                    <form class="row" method="post" action="{{route('admin-apply.store')}}">
                        @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-6 col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <select nname="user_id" class="custom-select rounded" required>
                                ...
                                <div class="col-xl-6 col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <select name="location" name="location" class="custom-select rounded" required>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$shop->location}}</td>
                                <td>
                                    @if ($shop->status === "Awaiting")
                                    <form class="row" method="post" action="{{route('admin-apply.update', $shop->id)}}">
                                        @csrf
			                            @method('PUT')
                                        <div class="form-group">
                                            <label class="text-dark ft-medium">Status</label>
                                    ...
                                    @else
                                        <span class="theme-cl">{{$shop->status}}</span>
                                    @endif
                                </td>
                            </tr>
                            @endforeach
