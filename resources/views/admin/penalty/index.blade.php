        ...
        <div class="colxl-12 col-lg-12 col-md-12">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="#" class="theme-cl">Process Penalties</a></li>
                </ol>
            </nav>
        </div>
    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-6 col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control rounded" min="0" step="500" name="total" placeholder="Amount" required>
                                    </div>
                                </div>
